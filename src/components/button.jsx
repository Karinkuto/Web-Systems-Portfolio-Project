export default function Button({ children, icon, ...props }) {
  ...
  const baseClasses = `
    flex items-center gap-[10px] justify-evenly w-fit h-fit py-[12px] px-[22px] rounded-[8px] border-primary border-[1px] text-[17px]/[24px] tracking-[0.03em] font-medium text-primary 
    bg-transparent 
